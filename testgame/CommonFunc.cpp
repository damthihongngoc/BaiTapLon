...
// Dùng để xử lí các thông tin chung như kích thước, màn hình , màu sắc hay các hàm chung như menu, xử lí va chạm....
    ...
    const std::string& img_name)
{
    ...
    pos[0].x = SCREEN_WIDTH * 0.3 - 300;
    pos[0].y = SCREEN_HEIGHT * 0.8 - 40;
    pos[1].x = SCREEN_WIDTH * 0.3 - 300;
    ...
    while (1)
    {
        time = SDL_GetTicks();
        //
        TextObject text_count_1;
        text_count_1.setColor(TextObject::WHITE_TEXT);
        text_count_1.SetText("Score:");
        text_count_1.setColor(color[0].r, color[0].g, color[0].b);
        text_count_1.RenderText(g_screen, SCREEN_WIDTH * 0.4, 2);
...
bool SDLCommonFunc::CheckCollision(const SDL_Rect& object1, const SDL_Rect& object2)
{
    ...
    // Case 1: size object a < size object b
    ...
    // Case 2: size object a > size object b
    ...
    // Case 3: size object a = size object b
